...
"""
Prompts used by the coder node.

Keeping these in their own module:
- keeps the main node readable
- makes prompt edits low-risk and easy to review
- helps tests/future config swap prompts without touching logic
"""

# Normal “workspace patch” mode: create files under workspace/ and suggest safe commands.
...
# Patch-proposal mode: write IMPROVEMENTS.patch + IMPROVEMENTS.md into workspace/
# WITHOUT modifying tracked repo files directly.
...
# One-shot correction appended when the model returns invalid JSON.
